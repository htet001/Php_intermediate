        ...
        <div class="col-md-8 offset-md-2">
            <div class="card p-5" style="background-color: blueviolet;">
                ...
                <form action="<?php echo URLROOT . 'user/register' ?>" method="post">
                    <div class="mb-3">
                        <label for="username" class="form-label "><b style="color: white;">Username</b></label>
                        <input type="text"
                    ...
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label "><b style="color: white;">Email
                                address</b></label>
                        <input type="email"
                    ...
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label "><b
                                style="color: white;">Password</b></label>
                        <input type="password"
                    ...
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label "><b style="color: white;">Confirm
                                Password</b></label>
                        <input type="password"
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="<?php echo URLROOT . 'user/login' ?>" style="color: tomato;" class="english">Already
                            Register, Please
                            Login</a>
                        <div class="mt-3">
