    ...
    <nav class="container navbar navbar-expand-lg navbar-light ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav" id="navright">
                ...
                <div class="dropdown">
                    <button class="english btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <ul class="dropdown-menu">
                        <?php if (getUserSession() != false) : ?>
                            <?php if (getUserSession()->admin === 1) : ?>
                                <a class="dropdown-item  english" href="<?php echo URLROOT . 'admin/home' ?>">Admin
                                    panel</a>
                            <?php elseif (getUserSession()->admin === 0) : ?>
                                <a class="dropdown-item  english" href="<?php echo URLROOT . 'user/member/1' ?>">Member
                                    panel</a>
                            <?php endif; ?>
